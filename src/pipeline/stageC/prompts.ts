...
export const SHARED_RULES_BLOCK = [
  ...
  "Use the exact `[source · as-of]` tag shown in the payload. If you cannot cite it, do not state it.",
...
export function buildJudgeFraming(): string {
  return [
    ...
    "  payload) vs INTERPRETATION disputes (both cite the same facts, differ on meaning — say why).",
    "",
